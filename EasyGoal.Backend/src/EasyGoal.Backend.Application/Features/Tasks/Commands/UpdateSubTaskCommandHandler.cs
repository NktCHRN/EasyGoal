...
public sealed class UpdateSubTaskCommandHandler : IRequestHandler<UpdateSubTaskCommand>
{
    private readonly IRepository<Task> _taskRepository;
    private readonly IRepository<Goal> _goalRepository;
    private readonly ICurrentApplicationUser _currentApplicationUser;

    public UpdateSubTaskCommandHandler(IRepository<Task> taskRepository, IRepository<Goal> goalRepository, ICurrentApplicationUser currentApplicationUser)
    {
    ...
    public async System.Threading.Tasks.Task Handle(UpdateSubTaskCommand request, CancellationToken cancellationToken)
    {
        ...
        task.UpdateSubTask(request.Id, request.Name);
