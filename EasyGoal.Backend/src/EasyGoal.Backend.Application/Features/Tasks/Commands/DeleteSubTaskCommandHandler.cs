...
public sealed class DeleteSubTaskCommandHandler : IRequestHandler<DeleteSubTaskCommand>
{
    private readonly IRepository<Task> _taskRepository;
    private readonly IRepository<Goal> _goalRepository;
    private readonly ICurrentApplicationUser _currentApplicationUser;

    public DeleteSubTaskCommandHandler(IRepository<Task> taskRepository, IRepository<Goal> goalRepository, ICurrentApplicationUser currentApplicationUser)
    {
    ...
    public async System.Threading.Tasks.Task Handle(DeleteSubTaskCommand request, CancellationToken cancellationToken)
    {
